...
namespace Algoritmos_Lineas
{
    public partial class FrmDDA : Form
    {
        ...
        private void btnDibujar_Click(object sender, EventArgs e)
        {
            ...
            dda = new DDA(new PointF(pInicialX, pInicialY), new PointF(pFinalX, pFinalY), picGrafico);

            dda.drawLine();

            // Llenar el ListBox con los puntos
            lstPuntos.Items.Clear();
            List<PointF> points = dda.GetPoints();
        ...
        private void btnSiguiente_Click(object sender, EventArgs e)
        {
            ...
            if (currentIndex < points.Count)
            {
                ...
                dda.drawPointAtIndex(currentIndex);
