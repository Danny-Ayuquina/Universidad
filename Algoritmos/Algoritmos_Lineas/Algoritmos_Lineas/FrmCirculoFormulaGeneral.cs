...
{
    public partial class FrmCirculoFormulaGeneral : Form
    {
        private CirculoFormulaGeneral circulo;
        private int currentIndex = 0;
        private Bitmap bitmap;
        private Graphics g;

        public FrmCirculoFormulaGeneral()
        {
            InitializeComponent();
            InitializeBitmap();
        ...
        private void btnDibujar_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                circulo = new CirculoFormulaGeneral(centroX, centroY, radio, picGrafico);
                circulo.drawCircle();
                ...
                {
                    lstPuntos.Items.Add($"({p.X:F0}, {p.Y:F0})");
                }

                currentIndex = 0;
                lblInfo.Text = $"Total de puntos: {points.Count}";
            }
            catch (Exception ex)
            {
