...
- **Root Directory:** (déjalo vacío si el main.py está en la raíz)
- **Runtime:** `Python 3`
...
### Opción A: Desplegar como Static Site

1. En Render, crea un nuevo **"Static Site"**
2. Conecta el mismo repositorio
3. Configuración:
   - **Build Command:** `cd customer-frontend && npm install && npm run build`
   - **Publish Directory:** `customer-frontend/dist`
